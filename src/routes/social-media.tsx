  ...
  head: () => ({
    meta: [
      { title: "Social Media — MegaLands" },
      {
        name: "description",
        content:
          "Follow the MegaLands project on social media for fieldwork news, publications, events and outreach activities.",
      },
      { property: "og:title", content: "Social Media — MegaLands" },
      {
        property: "og:description",
        content:
          "Follow @megalands_project on X/Twitter and Instagram for the latest project news.",
      },
    ...
    <PageShell>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="flex flex-wrap gap-4">
          ...
          >
            <Twitter size={16} /> @megalands_project
          </a>
          <a
          ...
          >
            <Instagram size={16} /> @megalands_project
          </a>
        </div>
        ...
        <div className="mt-16 grid gap-12 lg:grid-cols-2">
          <div>
            <h2 className="flex items-center gap-3 font-display text-3xl text-foreground">
              <Twitter size={22} className="text-ochre" /> Twitter / X
            </h2>
            <div className="mt-6 space-y-4">
              {tweets.map((t, i) => (
                <article key={i} className="rounded-2xl border border-border bg-card p-6 shadow-sm">
                  <p className="text-sm font-semibold text-foreground">@megalands_project</p>
